...
class Carta {
  ...
  factory Carta.fromJson(Map<String, dynamic> json) {
    return Carta(
      ...
      rawValor: (json['valor'] ?? json['value'] ?? '').toString(),
    );
  }
  ...
  static CartaColor _parseColor(dynamic colorData) {
    ...
    if (str.contains('amarill') || str.contains('yellow')) {
      return CartaColor.amarillo;
    }
  ...
  static CartaValor _parseValor(dynamic valorData) {
    ...
    switch (str) {
      case '0':
      case 'cero':
        return CartaValor.cero;
      case '1':
      case 'uno':
        return CartaValor.uno;
      case '2':
      case 'dos':
        return CartaValor.dos;
      case '3':
      case 'tres':
        return CartaValor.tres;
      case '4':
      case 'cuatro':
        return CartaValor.cuatro;
      case '5':
      case 'cinco':
        return CartaValor.cinco;
      case '6':
      case 'seis':
        return CartaValor.seis;
      case '7':
      case 'siete':
        return CartaValor.siete;
      case '8':
      case 'ocho':
        return CartaValor.ocho;
      case '9':
      case 'nueve':
        return CartaValor.nueve;
      case 'saltar':
      case 'skip':
      case 'bloqueo':
        return CartaValor.saltar;
      case 'reversa':
      case 'reverse':
      case 'cambio_sentido':
        return CartaValor.reversa;
      case '+2':
      case 'masdos':
      case 'mas dos':
      case 'draw2':
        return CartaValor.masDos;
      case '+4':
      case 'mascuatro':
      case 'mas cuatro':
      case 'draw4':
        return CartaValor.masCuatro;
      case 'cambiacolor':
      case 'cambia color':
      case 'color':
      case 'wild':
        return CartaValor.cambiaColor;
      default:
        return CartaValor.cero; // Fallback seguro
    }
  }
}
