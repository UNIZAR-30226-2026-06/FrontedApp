...
class ConfigCartasVsIaView extends StatefulWidget {
  ...
  const ConfigCartasVsIaView({
    super.key,
    required this.modoTitulo,
  });

  @override
  State<ConfigCartasVsIaView> createState() => _ConfigCartasVsIaViewState();
}

class _ConfigCartasVsIaViewState extends State<ConfigCartasVsIaView> {
  late final ConfigCartasVsIaViewModel vm;

  @override
  void initState() {
    super.initState();
    vm = ConfigCartasVsIaViewModel(modoTitulo: widget.modoTitulo);
  }
...
// ===== Widgets iguales a roles (copiados aquí) =====
