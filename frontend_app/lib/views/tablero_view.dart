...
class TableroView extends StatelessWidget {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // 🔥 4. NUEVO OVERLAY: PARTIDA CONGELADA (Consenso alcanzado)
  ...
  // 🔥 --- NUEVO WIDGET: PANTALLA DE PARTIDA PAUSADA ---
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFF81C784), // Verde web
                      foregroundColor: Colors.black,
                      padding: const EdgeInsets.symmetric(vertical: 14),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                    ),
                    icon: const Icon(Icons.play_arrow, size: 20),
                    label: const Text("Votar para reanudar", style: TextStyle(fontWeight: FontWeight.w800, fontSize: 15)),
                    onPressed: () {
                      // TODO: Lógica para votar reanudación
                      debugPrint("Botón reanudar pulsado");
                    },
                  ),
                ),
