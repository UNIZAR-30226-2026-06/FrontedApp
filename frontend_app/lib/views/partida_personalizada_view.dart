...
class PartidaPersonalizadaView extends StatefulWidget {
  ...
  @override
  State<PartidaPersonalizadaView> createState() =>
      _PartidaPersonalizadaViewState();
}
                              ...
                              children: [
                                ...
                                const Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 10),
                                    Text(
                                      PartidaPersonalizadaViewModel.tituloModo,
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 16,
                                        fontWeight: FontWeight.w900,
                                    ...
                                    children: [
                                                              ...
                                                              style: const TextStyle(
                                                                  ...
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w900)),
                                                          Text(
                                                              '${PartidaPersonalizadaViewModel.minCartas}-${PartidaPersonalizadaViewModel.maxCartas}',
                                                              style: const TextStyle(
                                                                  color: Colors
                                                                      .white38,
                                                                  fontSize: 8,
                                      ...
                                      _AnimatedGreenButton(
                                        ...
                                        onTap: vm.isCreating
                                            ? null
                                            : () {
                                                final partidaVm = context.read<
                                                    PartidaActualViewModel>();
                                      ...
                                      _AnimatedOutlineButton(
                                        ...
                                        onTap: () => vm.unirsePartida(context),
                                      ),
                                    ],
                                  ),
                                ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedScale(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  widget.selected ? const Color(0xFF5A86C9) : idleBg,
              ...
              boxShadow: (widget.selected || _isPressed)
                  ? [
                      BoxShadow(
                          color: (widget.selected ? gold : Colors.white)
                              .withOpacity(0.7),
                          blurRadius: 12,
                          spreadRadius: 2)
                    ]
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          height: 44,
          decoration: BoxDecoration(
            color: disabled ? green.withOpacity(0.5) : green,
            borderRadius: BorderRadius.circular(14),
            boxShadow: _isPressed
                ? [
                    BoxShadow(
...
class _AnimatedOutlineButtonState extends State<_AnimatedOutlineButton> {
  ...
  @override
  Widget build(BuildContext context) {
    const goldOutline = Color(0xFFF4C542);
    return GestureDetector(
      onTapDown: (_) => setState(() => _isPressed = true),
      onTapUp: (_) {
        setState(() => _isPressed = false);
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(color: goldOutline, width: 2),
            boxShadow: _isPressed
                ? [
                    BoxShadow(
                        color: goldOutline.withOpacity(0.7),
                        blurRadius: 15,
                        spreadRadius: 3)
                  ]
                : [],
