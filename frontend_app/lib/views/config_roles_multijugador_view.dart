...
class ConfigRolesMultijugadorView extends StatefulWidget {
  ...
  @override
  State<ConfigRolesMultijugadorView> createState() =>
      _ConfigRolesMultijugadorViewState();
}

class _ConfigRolesMultijugadorViewState
    extends State<ConfigRolesMultijugadorView> {
  late final ConfigRolesMultijugadorViewModel vm;
